...
?>
    <div class="container">
        <div class="container " style="background-color: rgb(230, 230, 230); padding-right:0px !important; padding-left:0px !important;">
            ...
            <!--Navbar-->
            <nav class="nav2 navbar navbar-expand-lg navbar-dark mdb-color lighten-3 mt-3 mb-5">
              ...
              <div class="collapse navbar-collapse" id="basicExampleNav">
                ...
                <ul class="navbar-nav mr-auto">
                  <li class="nav-item active">
                    <a class="nav-link titulo" href="">All
                      <span class="sr-only">(current)</span>
                    </a>
                  </li>
                <li class="nav-item"></li>
                    <a class="nav-link titulo" href="">Shirts</a>
                 
                  <li class="nav-item ">
                    <a class="nav-link titulo" href="">Sport wears</a>
                  </li>
                  <li class="nav-item titulo">
                    <a class="nav-link titulo" href="">Outwears</a>
                  </li>
            ...
            <section class="text-center mb-4">
             ...
             <!--Grid row-->
             <div class="row wow fadeIn" style="padding-left: 15px; padding-right: 15px;">
            
                <!--Grid row-->
              <div class="row wow fadeIn justify-content-center" style="padding-left: 15px; padding-right: 15px;">
