        ...
        <div class=" certificado w-75 m-5 " id="certificado">
            <div class="d-flex flex-row justify-content-center align-items-center h-100">
                <div class="p-5 w-100 d-flex flex-column  align-items-center  justify-content-center">
                    ...
                    <h2 class="p-0">Curso de PWCI</h2>
                    <span class="hr w-100 mt-3 mb-3"></span>
                    <p>Ha superado cumpliendo con los requisitos academicos exigidos en el curso <strong
                            style="text-transform: uppercase;">Programación web de capa intermedia</strong> de 40h de
                        duración. </p>
                    <p>Y para que asi conste, hacemos entrega del presente diploma acreditativo a <strong>Juan Mata
                            Medrano</strong> .</p>
                    <i>3 de Junio del 2022</i>
